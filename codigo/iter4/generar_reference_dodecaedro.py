...
# Defaults actualizados para iter 4 (2026-06-11):
#   Dodecaedro fisico nuevo: edge=17.5 mm, marker=13.4 mm.
#   IDs reasignados: TOP=170, sup=[171..175], inf=[176..180].
# Si necesitas los defaults de iter 2-3, pasar las flags explicitas en CLI:
#   --id-top 151 --ids-superior 152,153,154,155,156 --ids-inferior 157,158,159,160,161 \
#   --edge-mm 20 --marker-mm 16
DEFAULT_EDGE_MM = 17.5
DEFAULT_MARKER_MM = 13.4
DEFAULT_ID_TOP = 170
DEFAULT_IDS_SUPERIOR = [171, 172, 173, 174, 175]
DEFAULT_IDS_INFERIOR = [176, 177, 178, 179, 180]
